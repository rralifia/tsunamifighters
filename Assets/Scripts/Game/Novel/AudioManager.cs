...
public class AudioManager : MonoBehaviour 
{
	...
	public void PlaySong(AudioClip song, float startingVolume, float maxVolume, float pitch = 1f, bool playOnStart = true, bool loop = true)
	{
		if (song != null)
		{
			...
			if (activeSong == null || activeSong.clip != song)
				activeSong = new SONG(song, startingVolume, maxVolume, pitch, playOnStart, loop);
		}
		else if (song == null)
        {
            activeSong.Stop();
            activeSong = null;
            Debug.Log("Active Song: " + activeSong);
        }
	...
	public class SONG
	{
		...
		public SONG(AudioClip clip, float startingVolume, float _maxVolume, float pitch, bool playOnStart, bool loop)
		{
